...
use CLADevs\VanillaX\world\sounds\ItemFrameAddItemSound;
use CLADevs\VanillaX\utils\item\NonAutomaticCallItemTrait;
use CLADevs\VanillaX\blocks\tile\campfire\CampfireTile as TileCampfire;
...
class Campfire extends Transparent implements NonAutomaticCallItemTrait {
    ...
    public function onInteract(Item $item, int $face, Vector3 $clickVector, ?Player $player = null): bool
    {
        if ($player !== null) {
            ...
            if ($tile instanceof TileCampfire && $tile->addItem(clone $item->setCount(1))) {
                $item->pop();
